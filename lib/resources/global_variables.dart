...
final TextStyle postContent = GoogleFonts.getFont('Open Sans', textStyle: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.w600));
final TextStyle postDescription = GoogleFonts.getFont('Open Sans', textStyle: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.w600));
